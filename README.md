...
(или распаковать содержимое архива в папку на диске и запустить приложение uninstall.exe, которое установит приложение на ваш компьютер)
## 10. Запуск
...
3.	habrahabr.ru [статья](https://habrahabr.ru/post/146449/)
