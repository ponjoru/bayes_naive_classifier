...
## Запуск
Для запуска приложения необходимо собрать исходный код и запустить его в среде разработки. Полученный .exe файл требуется поместить в папку с приложением.
## Интерфейс
